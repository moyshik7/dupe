        ...
        try {
            ...
            .then(anime => {
                ...
                .addFields(
                    ...
                    {
                        name: "__Type__ :", value: a.attributes.showType || "N/A"
                    },
                    {
                        name: "__Episodes__ :", value: a.attributes.episodeCount || "N/A"
                    },
                    {
                        name: "__Total Length__ :", value: le || "N/A"
                    }, {
                        name: "__Status__ :", value: a.attributes.status || "N/A"
                    }, {
                        name: "__Rank__ :", value: a.attributes.ratingRank || "N/A"
                    }, {
                        name: "__Rating__ :", value: a.attributes.averageRating || "N/A"
                    }, {
                        name: "__Minimum age__ :", value: a.attributes.ageRatingGuide || "N/A"
                    }, {
                        name: "__Trailer__ :", value: `[https://youtu.be/${a.attributes.youtubeVideoId || "N/A"}](https://youtu.be/${a.attributes.youtubeVideoId || "N/A"})`
                    }, {
                        name: "__NSFW__ :", value: ns || "N/A"
                    }, {
                        name: '\u200B', value: '\u200B'
                    }
                )
